...
import 'package:coffe_shop_app/features/auth/presentation/screens/login_screen.dart';
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TitleWidget(text: StringsAllApp.createAccountText),
                  SizedBox(height: getScreenHeight(10)),
                  SubTitleWidget(text: StringsAllApp.titleCreateAccountText),
                  SizedBox(height: getScreenHeight(20)),
                  // Name Field
                  Text(
                    StringsAllApp.nameText.tr(context),
                    style: Theme.of(context).textTheme.titleMedium,
                  ),
                  SizedBox(height: getScreenHeight(5)),
                  PrimaryTextFormField(
                    hintText: StringsAllApp.exJohnDoeText.tr(context),
                    validator: (value) {
                      if (value!.isEmpty) {
                  ...
                  CheckboxWidget(
                    ...
                    text: StringsAllApp.agreeWithText.tr(context),
                    widget: GestureDetector(
                      onTap: () {
                        // Handle terms and conditions page
                      },
                      child: Text(
                        StringsAllApp.termsConditionText.tr(context),
                  ...
                  // Sign Up Button
                  PrimaryButtonApp(
                    text: StringsAllApp.signUpText.tr(context),
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  SizedBox(height: getScreenHeight(24)),
                  QuestionWidget(
                    questionText: StringsAllApp.alreadyHaveAccountText.tr(
                      context,
                    ),
