        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                TitleWidget(text: StringsAllApp.completeYourProfileText),
                SizedBox(height: getScreenHeight(10)),
                SubTitleWidget(
                  text: StringsAllApp.completeYourProfileTitleText,
                ),
                ...
                // Phone Number Field
                Text(
                  StringsAllApp.phoneNumberText.tr(context),
                  style: Theme.of(context).textTheme.titleMedium,
                ),
                SizedBox(height: getScreenHeight(5)),
                Row(
                  children: [
                    ...
                    Expanded(
                      child: PrimaryTextFormField(
                        ...
                        hintText: StringsAllApp.enterPhoneNumberText.tr(
                          context,
                        ),
                ...
                // Gender Field
                Text(
                  StringsAllApp.genderText.tr(context),
                  style: Theme.of(context).textTheme.titleMedium,
                ),
                SizedBox(height: getScreenHeight(5)),
                DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: StringsAllApp.selectGenderText.tr(context),
                ...
                PrimaryButtonApp(
                  text: StringsAllApp.completeProfileText.tr(context),
                  onPressed: () {
                    Navigator.push(
                      context,
