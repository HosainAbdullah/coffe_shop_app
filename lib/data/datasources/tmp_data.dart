import 'package:coffe_shop_app/domain/entities/coffee.dart';
import 'package:coffe_shop_app/domain/entities/introduction.dart';
...
class DataTmp {
  ...
  static final List<Introduction> introductionList = [
    ...
    Introduction(
      ...
      imageUrl:
          'https://images.pexels.com/photos/14492519/pexels-photo-14492519.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
