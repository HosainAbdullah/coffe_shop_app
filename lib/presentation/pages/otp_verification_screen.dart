...
import 'package:coffe_shop_app/presentation/pages/new_password.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            TitleWidget(text: 'Verify Code'),
            SizedBox(height: getScreenHeight(10)),
            SubTitleWidget(text: "Please enter the code we just sent to email"),
            Text(
              'example@email.com',
