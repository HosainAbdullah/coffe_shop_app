...
import 'package:coffe_shop_app/presentation/pages/product_details_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actionsPadding: SizeConfig.rightPadding(),
        actions: [
          IconButton(
            icon: Icon(Icons.shopping_cart, color: context.colors.iconDefault),
            style: ElevatedButton.styleFrom(
              ...
              padding: SizeConfig.defaultPadding(size: 13),
            ),
            onPressed: () {},
          ),
          SizedBox(width: 10),
          IconButton(
            icon: Icon(Icons.notifications, color: context.colors.iconDefault),
            style: ElevatedButton.styleFrom(
              backgroundColor: context.colors.bgPrimaryColor,
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(
